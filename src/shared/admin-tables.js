...
import AdminAwardDrawRows from "../components/admin/AdminAwardDrawRows.vue";
...
function render(payload = {}) {
  ...
  app.config.errorHandler = (error) => {
    console.error("ROOC Vue admin table failed:", error);
  };
  app.mount(target);
